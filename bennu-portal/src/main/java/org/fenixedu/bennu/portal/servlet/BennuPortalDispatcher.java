...
public class BennuPortalDispatcher implements Filter {
    ...
    /**
     * Key for the request attribute containing the selected {@link MenuFunctionality}
     */
    public static final String SELECTED_FUNCTIONALITY = "PORTAL_SELECTED_FUNCTIONALITY";
    ...
    public static MenuFunctionality getSelectedFunctionality(HttpServletRequest request) {
        return (MenuFunctionality) request.getAttribute(SELECTED_FUNCTIONALITY);
    }
